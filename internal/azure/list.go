...
func ListResourcesByType(ctx context.Context, cred azcore.TokenCredential, subscriptionID, resourceType string) ([]string, error) {
...
func ListResourceGroups(ctx context.Context, cred azcore.TokenCredential, subscriptionID string) ([]string, error) {
